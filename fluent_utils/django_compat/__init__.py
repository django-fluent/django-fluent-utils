...
from .django17 import is_installed, get_models, get_app_names, get_app_label
from .django18 import CallableChoiceIterator
...
__all__ = (
    ...
    'is_installed', 'get_models', 'get_app_names', 'get_app_label',
    'smart_text',
)
